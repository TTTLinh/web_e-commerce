...
class PageController extends Controller
{
    ...
    public function __construct(){
        ...
        $this->data_seo = new SeoHelper('Kính chào quý khách', 'Bàn decor, gương decor, thảm decor, ghể decor, tranh decor', 'VINANEON - Chuyên cung cấp những vật phẩm decor uy tín, chất lượng, giá rẻ', 'http://vkuer.com:80/');
        view()->share([
    ...
    public function index(){
        ...
        // // Gọi đến BotManController để xử lý BotMan logic
        // $botmanController = app(BotManController::class);
        // $botmanController->handle();

        // // Nhận phản hồi từ BotMan
        // $botmanResponse = $botmanController->getResponseFromBotMan();
